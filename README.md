...
Для создания пользовательского портрета были рассчитаны ключевые характеристики: доля школьников и учителей, средний возраст, интервал между регистрацией и первым обращением, а также уровень многократных обращений. Выявлено, что после взаимодействия с поддержкой дневная активность (DAU) мессенджера статистически достоверно возрастает, что подтверждает важность сервиса для удержания аудитории.
...
Полученные опорные метрики и отраслевые бенч‑уровни позволяют оптимизировать планирование ресурсов службы поддержки и закладывают основу для построения unit‑экономики подразделения. В дальнейшем целесообразно расширить анализ за счёт обработки текстовых тегов обращений и интеграции системы связанных метрик для контроля SLA, CSAT и скорости обработки запросов.
